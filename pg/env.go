...
var (
	DBReadURL       = "postgresql://laocheng.cheng@localhost:5432/students" // https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING
	DBWriteURL      = "postgresql://laocheng.cheng@localhost:5432/students"
